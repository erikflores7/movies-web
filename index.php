...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand active" href="index.php">Moovies  <span class="sr-only">(current)</span></a>
        </div>
...
<div class="row">
    ...
    <form id="search">
        ...
        <div class="col-sm-1 form-group">
            <input type="text" class="form-control" placeholder="Year" id="search3">
        </div>
        <button type="submit" class="col-sm-1 btn btn-primary">Search</button>
    </form>
...
<script> extractSearch(document.location); </script>
